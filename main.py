...
with tab_detalles:
    ...
    if not df_detalles_filtrado.empty:
        ...
        # 1. Crear el objeto figura
        fig_aportaciones = go.Figure()
        
        # 2. Añadir PRIMERO las trazas (Para que los identificadores de eje 'y' e 'y2' existan con datos)
        ...
        # Puntos y Línea: Precio de compra (Eje Y secundario)
        ...
        # 3. Aplicar el Layout configurando el comportamiento de los ejes Y simultáneos
        ...
        # 4. Añadir la línea horizontal del VL actual usando add_hline de forma segura
